...
const Leaderboard = ({ score }) => {
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="border-white border-solid border-2 rounded-xl font-semibold w-[20rem] md:w-[40rem] h-[5rem] md:h-[5rem] bg-black flex justify-center items-center p-4 mb-5 overflow-hidden">
        <p className="text-white text-[1rem] md:text-[1.5rem] leading-relaxed">Score</p>
      </div>
